...
if __name__ == '__main__':
    ...
    if sys.argv[1] == 'api':
        ...
        pytest.main(['./TestCase/TestConnectCase/test_connectTransaction.py::TestConnectTransactionApi::test_connect_transaction_011', '-v', '--alluredir', './Reports', '--clean-alluredir'])
    else:

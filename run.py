...
if __name__ == '__main__':
    ...
    if sys.argv[1] == 'api':
        ...
        pytest.main(['./TestCase/TestAccountingCase/test_payout_accounting.py::TestPayOutAccountingApi::test_payout_accounting_001', '-v', '--alluredir', './Reports', '--clean-alluredir'])

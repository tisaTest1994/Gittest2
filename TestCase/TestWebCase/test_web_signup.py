...
class TestWebSignup:
    ...
    #         operate_element_web('loginPage', 'login_forgotpw', 'check'), '未弹出重置密码框'
    #
    ...
    #         operate_element_web('signupPage', "signup_form_password_email", "input", "<>test@cabital.com")
    #         assert operate_element_web("signupPage", "signup_form_password_email-helper-text", "get_text")\
    #                == 'Please enter a valid email address', "未显示邮箱格式错误或提示信息错误"
    #     with allure.step("如@后为[ ]内非4个一到三位数字且以.分割，如：test@[23.143.42.1234]"):
    #         operate_element_web('signupPage', "signup_form_password_email", "delete")
    #         operate_element_web('signupPage', "signup_form_password_email", "input",
    #                             "test@[23.143.42.1234]")
    #         assert operate_element_web("signupPage", "signup_form_password_email-helper-text", "get_text")\
    #                == 'Please enter a valid email address', "未显示邮箱格式错误或提示信息错误"
    #     with allure.step("如@后为大写字母，小写字母，“-”或数字，.后面不为2个或2个以上的大写字母或小写字母。如：test@qwe12.c 和test@DF-.a1"):
    #         operate_element_web('signupPage', "signup_form_password_email", "delete")
    #         operate_element_web('signupPage', "signup_form_password_email", "input", "test@qwe12.c")
    #         assert operate_element_web("signupPage", "signup_form_password_email-helper-text", "get_text")\
    #                == 'Please enter a valid email address', "未显示邮箱格式错误或提示信息错误"
    #         operate_element_web('signupPage', "signup_form_password_email", "delete")
    #         operate_element_web('signupPage', "signup_form_password_email", "input", "test@DF-.a1")
    #         assert operate_element_web("signupPage", "signup_form_password_email-helper-text", "get_text")\
    #                == 'Please enter a valid email address', "未显示邮箱格式错误或提示信息错误"
    #     with allure.step("邮箱含中文，如测试@163.com"):
    #         operate_element_web('signupPage', "signup_form_password_email", "delete")
    #         operate_element_web('signupPage', "signup_form_password_email", "input", "测试@163.com")
    #         assert operate_element_web('signupPage', "click_sendcode", 'check_enabled'), "send code显示状态错误"
    #     with allure.step("输入正确格式邮箱"):
    #         operate_element_web('signupPage', "signup_form_password_email", "delete")
    #         operate_element_web('signupPage', "signup_form_password_email", "input", "qwe@cabital.com")
    #         assert operate_element_web('signupPage', "click_sendcode", 'check_enabled'), "send code显示状态错误"
    #
    ...
    #         operate_element_web('signupPage', "mailcode", "input", "6666666")
    #         # 输入7个6，看value是否为6个6。
    ...
    #         operate_element_web('signupPage', "signup_form_password_input", "input", "Aaaa1234")
    #         assert self.driver.find_element_by_xpath('//*[@id="signupForm"]/div[4]/p'), "输入正确格式密码，提示信息未消失"
    #         # Password显隐默认不显示
    #         assert operate_element_web('signupPage', "VisibilityOffIcon", "check"),\
    #             "密码显隐默认状态错误"
    #         # 密码默认不显示，点击密码显隐按钮后密码显示
    #         operate_element_web('signupPage', "VisibilityOffIcon")
    #         assert self.driver.find_element_by_xpath('//*[@id="signup_form_password_input"][@type="text"]'),\
    #             "密码未显示"
    #         # 再次点击密码显隐按钮，密码隐藏
    #         operate_element_web('signupPage', "VisibilityIcon")
    #         assert self.driver.find_element_by_xpath('//*[@id="signup_form_password_input"][@type="password"]'),\
    #             "密码未隐藏"
    #     with allure.step("错误密码格式1：密码设置位数少于8位"):
    #         operate_element_web('signupPage', "VisibilityOffIcon")
    #         operate_element_web('signupPage', "signup_form_password_input", "delete")
    #         operate_element_web('signupPage', "signup_form_password_input", "input", "Aaaa123")
    ...
    #         operate_element_web('signupPage', "signup_form_password_input", "delete")
    #         operate_element_web('signupPage', "signup_form_password_input", "input", "你好中国!@#1")
    ...
    #         # 复选框默认不勾选,点击复选框
    #         assert (operate_element_web('signupPage', "signup_termschk", "check_selected")) is False,\
    #             "复选框默认状态错误"
    #         operate_element_web('signupPage', "signup_termschk")
    #         assert operate_element_web('signupPage', "signup_termschk", "check_selected"), "复选框勾选失败"
    #     # with allure.step("点击Terms of Services,然后并关闭页面"):
    #     #     operate_element_web('signupPage', "service")
    #     #     assert operate_element_web("signupPage", "full-width-tab-0", "check"), "Terms of Services页面未显示"
    #     #     # 关闭窗口的close按钮缺一个id
    ...
    #     #     operate_element_web('signupPage', "privacy")
    #     #     assert operate_element_web("signupPage", "full-width-tab-0", "check"), "Privacy Policy页面未显示"
    #

...
class TestAccountApi:
    ...
    #                                             url='/api/v1/connect/account/{}/unlink'.format(account_id),
    ...
    #         r = session.request('POST', url='{}/connect/account/{}/unlink'.format(self.url, account_id), data=json.dumps(data), headers=headers)
    #         print(r.json())

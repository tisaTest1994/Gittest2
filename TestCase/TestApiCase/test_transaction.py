...
class TestTransactionApi:
    ...
    @allure.title('test_transaction_001 查询钱包所有币种详细金额以及报价，以美元价格返回')
    ...
    @allure.title('test_transaction_002 查询全部交易记录')
    ...
    @allure.title('test_transaction_003 查询指定Debit记录')
    ...
    @allure.title('test_transaction_005 web查询全部交易记录')
    ...
    @allure.title('test_transaction_006 web查询很后面页面交易数据为空')

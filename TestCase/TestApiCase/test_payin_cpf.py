...
class TestPayinCpfApi:
    ...
    def test_payin_cpf_001(self):
        cpf_info = [('yanting.huang+4@cabital.com', 0),
                    ('yanting.huang+159@cabital.com', 1),
                    ('yanting.huang+162@cabital.com', 2),
                    ('yanting.huang+160@cabital.com', 3),
        ...
        for i in cpf_info:
            ...
            with allure.step("请求数据"):
                data = {
                    ...
                    "type": "Credit",
                    "transactionId": "c21cf84a-0ff5-4873-a010-00c6ee07004",
                    "counterpart": {
                        "name": "Yan Ting161",
                        "taxId": "123.322.238-98",
                        "bankAccount": "2342-4",
    ...
    def test_payin_cpf_003(self):
        cpf_info = [('yanting.huang@cabital.com', 3)]
        for i in cpf_info:
            cpf_account = i[0]
            headers['Authorization'] = "Bearer " + ApiFunction.get_account_token(account=cpf_account)
            with allure.step("请求数据"):
                data = {
                    "accountId": "b013327e-ae65-4197-acf6-806f03873f51",
                    "amount": {
                        "amount": 2000,
                        "currency": "BRL"
                    },
                    ...
                    "dateDetailed": "0001-01-01T00:00:00+00:00",
                    "type": "Credit",
                    "transactionId": "c21cf84a-0fd5-4873-a010-00c6ee07004",
                    "counterpart": {
                        "name": "Yanting22 Huang33",
                        "taxId": "123.322.238-98",
                        "bankAccount": "2342-4",

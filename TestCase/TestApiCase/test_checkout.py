...
class TestCheckoutApi:
    ...
    # 从接口获取所有币种对，还没写完
    # @allure.title('test_check_out_002获取报价')
    ...
    #
    #         pair = ''
    #         r = session.request('GET', url='{}/acquiring/buy/quotes/{}'.format(env_url, pair), headers=headers)
    #     with allure.step("校验状态码"):
    #         assert r.status_code == 200, "http 状态码不对，目前状态码是{}".format(r.status_code)
    #     with allure.step("状态码和返回值"):
    #         logger.info('状态码是{}'.format(str(r.status_code)))
    ...
    @allure.title('test_check_out_003获取数字货币购买人信息')
    ...
    @allure.title('test_check_out_004获取购买数字货币费用-with card')
    ...
    @allure.title('test_check_out_005获取购买数字货币费用，使用不支持的scheme')
    ...
    @allure.title('test_check_out_006获取购买数字货币费用-no card')
    ...
    @allure.title('test_check_out_007获取购买数字货币费用规则-with card')
    ...
    @allure.title('test_check_out_008获取购买数字货币费用规则-no card')
    ...
    @allure.title('test_check_out_009获取购买数字货币费用规则-no card,使用不支持的币种')
